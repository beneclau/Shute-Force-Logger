...
namespace SimpleSpectrometer
{
    ...
    {
      //  public float GetCOG;
         static float thresholde = 0.0f;
         static float peakThresholde = 0.0f;
         static float waveRight =0.0f;
         static float waveLeft = 0.0f;
         static float COGresult = 0.0f;
         static float COGinWaveLength = 0.0f;
         static float COGmaxValue = 0.0f;
         static double[] waveCof = new double[4];
       ...
       //public static float COGmaxValue = 0.0f;
        ...
        public void SetWaveCof(double[] wcof)
        {
            ...
            waveCof[2] = wcof[2];
            waveCof[3] = wcof[3];
            Console.WriteLine("3: {0}", waveCof[0]);
            Console.WriteLine("3: {0}", waveCof[1]);
            Console.WriteLine("3: {0}", waveCof[2]);
            Console.WriteLine("3: {0}", waveCof[3]);
        }
